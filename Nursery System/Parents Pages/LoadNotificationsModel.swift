...
protocol LoadNotificationsModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}

class LoadNotificationsModel: NSObject, URLSessionDelegate {
    
    //properties
    weak var delegate: LoadNotificationsModelProtocol!
