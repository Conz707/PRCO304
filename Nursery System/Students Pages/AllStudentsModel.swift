...
protocol AllStudentsModelProtocol: class {
    func itemsDownloaded(items: NSArray)
}
class AllStudentsModel: NSObject, URLSessionDelegate {
        
        //properties
        weak var delegate: AllStudentsModelProtocol!
        
        let urlPath: String = "https://shod-verses.000webhostapp.com/AllStudents.php"
